...
#define HOMING_BACKOFF_POST_MM { 5, 5, 16 }  // (linear=mm, rotational=°) Backoff from endstops after homing
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //RBS
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 3, 25 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "G91\nG0 Z15 F600\nG90\nG0 X170 Y290 F3000"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_2_DESC "Select OEM Tool"
  #define MAIN_MENU_ITEM_2_GCODE "M811"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Small Titan Areo"
  #define MAIN_MENU_ITEM_3_GCODE "M812"
  //#define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Large Titan Areo"
  #define MAIN_MENU_ITEM_4_GCODE "M813"
